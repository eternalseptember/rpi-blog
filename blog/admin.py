...
# Accepts lists or tuples. I use lists.
...
class ConnectionAdmin(admin.ModelAdmin):
    list_display = ["get_category", "get_post", "get_comment"]
    fields = ["category", "post", "comment"]
    list_per_page = 20
    readonly_fields = ["category", "post"]
    actions = None
    ...
    def get_category(self, obj):
        return get_admin_text_link(obj.category, obj.category, 20)
    
    @admin.display(description="post")
    def get_post(self, obj):
        return get_admin_text_link(obj.post, obj.post, 20)
